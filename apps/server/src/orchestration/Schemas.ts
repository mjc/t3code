import {
  ...
  ThreadTurnReconciledPayload as ContractsThreadTurnReconciledPayloadSchema,
...
export const ThreadTurnReconciledPayload = ContractsThreadTurnReconciledPayloadSchema;
